 ...
 * 
 * Time Complexity O(4*row*col) => O(row*col)
...
public class TreasureIsland {
	...
	public int treasureIsland(char[][] island) {
		...
		visited[0][0] = true;
		int[][] dirs = new int[][]{{1, 0}, {-1, 0}, {0, 1}, {0, -1}};// will add it to find index of adjacent cells
	...
	public static void main(String[] args) {
		...
		int result = new TreasureIsland().treasureIsland(island);
