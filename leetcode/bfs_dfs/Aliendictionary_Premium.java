...
/*
 * There is a new alien language which uses latin alphabet. However, the order among letters are unknown to you.
 * You receive a list of non-empty words from dictionary, where words are sorted lexicographically by the rules
 ...
 */
public class Aliendictionary_Premium {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		String words[] = {"baa", "abcd", "abca", "cab", "cad"};
		Aliendictionary_Premium ad = new Aliendictionary_Premium();
